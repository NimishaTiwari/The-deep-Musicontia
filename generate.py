...
Original file is located at
    https://colab.research.google.com/drive/1dwN6NMpD2pXpPRu9gOzzhqzGSEN3uvxD
"""
...
def generate():
    ...
    with open('data/hiphop_notes_final', 'rb') as filepath:
...
def create_network_add_weights(network_input, n_vocab):
    ...
    model.load_weights('hiphop-weights.hdf5')
    return model
...
def create_midi(prediction_output):
    ...
    midi_stream.write('midi', fp='hiphop.mid')
